...
// One-click Google OAuth. Handles its own loading state.
// Used in both LoginForm and RegisterForm.
//
// USAGE:
...
// Google "G" SVG — no external image needed
const GoogleIcon = () => (
  ...
  return (
    <motion.button
      ...
      className="w-full flex items-center justify-center gap-3
                 rounded-xl py-3 px-5 text-[14px] font-medium
